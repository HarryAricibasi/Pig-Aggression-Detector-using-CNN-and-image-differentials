...
# Specify paths
dataset_path = "C:\\Users\\Harry\\PigAggressionData\\pig_behaviour_classifier_datasets_diff1current\\"
train_dir = os.path.join(dataset_path, 'train')
validation_dir = os.path.join(dataset_path, 'validation')
test_dir = os.path.join(dataset_path, 'test')

# Configure model name
tag = "diff1_current_100"
...
fields1 = ['train loss', "val loss"]
rows1 = [loss, val_loss]
with open('csv100current.csv', 'w') as f:
    write = csv.writer(f)
